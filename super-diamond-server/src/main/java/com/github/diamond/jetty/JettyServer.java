...
public class JettyServer {
    ...
    public static final String  CONTEXTPATH = "/superdiamond";
    ...
    static {
        try {
            ...
            serverPort = config.getInt("jetty.port", 8080);
            serverHost = config.getString("jetty.host");
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        ...
        context.setConfigurations(new Configuration[] { new AnnotationConfiguration(), new WebInfConfigurationExt(),
    ...
    private static void addShutdownHook(final Server server) {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread() {
            public void run() {
                ...
                try {
                    LOGGER.info("jetty stop start......");
                    server.stop();
                    LOGGER.info("jetty stop end......");
                    LOGGER.info("jetty destory start......");
                    server.destroy();
                    LOGGER.info("jetty destory end......");

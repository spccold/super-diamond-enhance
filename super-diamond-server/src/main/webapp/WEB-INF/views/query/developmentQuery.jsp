...
<a class="brand" href="/superdiamond/index">首页</a> >> 配置查询  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="brand" href="/superdiamond/query/test">TESE</a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="brand" href="/superdiamond/query/build">BUILD</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="brand" href="/superdiamond/query/production">PRODUCTION</a>
<br/><br/> 

<form id ="queryForm" action='<c:url value="/query/development" />' >

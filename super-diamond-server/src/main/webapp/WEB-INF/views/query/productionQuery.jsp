...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="brand" href="/superdiamond/query/test">TESE</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="brand" href="/superdiamond/query/build">BUILD</a>
<br/><br/> 

<form id ="queryForm" action='<c:url value="/query/production" />' >

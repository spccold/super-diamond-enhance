        		...
        		<div class="span2">
          			<div class="well sidebar-nav">
            			<ul class="nav nav-list">
              				...
              				<li id="indexId"><a href='<c:url value="/index" />'>配置管理</a></li>
              				<!-- 屏蔽权限问题 -->
              				...
              				<li id="queryId"><a href='<c:url value="/queryConfig" />'>配置查询</a></li>
              				<c:if test="${sessionScope.sessionUser.userCode == 'admin'}">
              					<li id="projectId"><a href='<c:url value="/project/index" />'>项目管理</a></li>
              					<li id="moduleId"><a href='<c:url value="/moduleManage/index" />'>模块管理</a></li>

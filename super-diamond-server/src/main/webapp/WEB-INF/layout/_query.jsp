	...
	<script type='text/javascript'>
	    var options = {
	        ...
	        pageUrl: function(type, page, current){
	            return "/superdiamond/query/<c:out value="${type}"/>?page="+page+"&moduleName="+"<c:out value="${moduleName}"/>"
	            +"&configKey="+"<c:out value="${configKey}"/>"
	            +"&configValue="+"<c:out value="${configValue}"/>"
	            +"&configDesc="+"<c:out value="${configDesc}"/>";
	        }
	    }
